...
const SUPER_ADMIN_INITIAL_PASSWORD     = process.env.SUPER_ADMIN_INITIAL_PASSWORD || null;

if(!LONG_TOKEN_SECRET || !SHORT_TOKEN_SECRET || !NACL_SECRET || !SUPER_ADMIN_INITIAL_PASSWORD) {
